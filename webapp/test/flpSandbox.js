		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Citas Cambaceo",
									"targetURL": "#devcitascambaceo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"devcitascambaceo-display": {
								"semanticObject": "devcitascambaceo",
								"action": "display",
								"description": "Consumo de Odatas",
								"title": "Citas Cambaceo",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dev.citascambaceo",
									"url": sap.ui.require.toUrl("dev/citascambaceo")
								}
							}
						}
					}
